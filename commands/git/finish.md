...
Deployment command: [your deployment command here]
...
Failed tests:
✗ UserService.test.js - should authenticate user
  (expected 200, got 401)
✗ PaymentController.test.js - should process payment
  (timeout)
...
Start new feature: /feature <name>
```
...
Deploy command: [your deployment command]
```
